    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.DELETE, "/api/multas/**").hasRole(Rol.ADMIN.name())
                        .requestMatchers(HttpMethod.POST, "/api/multas/**").hasAnyRole(Rol.ADMIN.name(), Rol.BIBLIOTECARIO.name())
                        .requestMatchers(HttpMethod.GET, "/api/multas/**").hasAnyRole(Rol.ADMIN.name(), Rol.BIBLIOTECARIO.name())
