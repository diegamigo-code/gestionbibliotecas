    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.DELETE, "/api/devoluciones/**").hasRole(Rol.ADMIN.name())
                        .requestMatchers(HttpMethod.POST, "/api/devoluciones/**").hasAnyRole(Rol.ADMIN.name(), Rol.BIBLIOTECARIO.name())
                        .requestMatchers(HttpMethod.GET, "/api/devoluciones/**").hasAnyRole(Rol.ADMIN.name(), Rol.BIBLIOTECARIO.name())
