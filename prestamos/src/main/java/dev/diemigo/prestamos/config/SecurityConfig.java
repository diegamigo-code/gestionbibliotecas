    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.DELETE, "/api/prestamos/**").hasRole(Rol.ADMIN.name())
                        .requestMatchers(HttpMethod.POST, "/api/prestamos/**").hasAnyRole(Rol.ADMIN.name(), Rol.BIBLIOTECARIO.name())
                        .requestMatchers(HttpMethod.GET, "/api/prestamos/**").hasAnyRole(Rol.ADMIN.name(), Rol.BIBLIOTECARIO.name())
